...
var Test = React.createClass({displayName: "Test",
    ...
    render() {
        return (React.createElement("div", null, this.props.id, ":", this.props.name));
    },
});

var component = React.render(React.createElement(Test, {name: "var"}), document.getElementById('app'));

component.setProps({ name: 'Yossy' }, function() {
    alert('Yossy!!');
});
component.replaceProps({ name: 'Bossy' });
